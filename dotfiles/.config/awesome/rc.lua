...
naughty = require("naughty") -- was local but setted it for lua commands to global
...
beautiful.init(gears.filesystem.get_themes_dir() .. "maro/theme.lua")

-- lua commands
helper_themes_location = function() naughty.notify{text=tostring(gears.filesystem.get_themes_dir()), bg="#00ff00"} end
